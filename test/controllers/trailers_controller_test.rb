...
class TrailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trailer" do
    assert_difference("Trailer.count") do
      post trailers_url, params: { trailer: { art: @trailer.art, kennzeichen: @trailer.kennzeichen } }
    end
  ...
  test "should update trailer" do
    patch trailer_url(@trailer), params: { trailer: { art: @trailer.art, kennzeichen: @trailer.kennzeichen } }
