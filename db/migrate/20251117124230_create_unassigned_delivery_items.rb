...
# db/migrate/XXXXXX_create_unassigned_delivery_items.rb
class CreateUnassignedDeliveryItems < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :unassigned_delivery_items, :auftstatus
    add_index :unassigned_delivery_items, :erledigt
    add_index :unassigned_delivery_items, :invoiced
    add_index :unassigned_delivery_items, :gedruckt
    add_index :unassigned_delivery_items, :lkwnr
  end
end
