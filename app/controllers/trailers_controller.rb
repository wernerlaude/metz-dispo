class TrailersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @trailer.update(trailer_params)
        format.html { redirect_to @trailer, notice: "Trailer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to trailers_path, notice: "Trailer was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_trailer
      @trailer = Trailer.find(params.expect(:id))
    end
